...
import { ErrorBoundary, Suspense, createMemo, lazy } from 'solid-js'
...
import { generateModalRoutes, generatePreservedRoutes, generateRegularRoutes } from '@generouted/solid-router/core'
...
function App() {
  return (<ErrorBoundary fallback={(error, reset) => Catch?.({ error, reset })}>
